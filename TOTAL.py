...
shutil.copy('gb_parsed.fasta', str(usr_ip)+"_Results"+"/")
...
for record in SeqIO.parse(usr_query, "fasta"):
    shutil.copy(record.id+"_bpresults.tsv", str(usr_ip)+"_Results"+"/")
    shutil.copy(record.id+"_filtred.tsv", str(usr_ip)+"_Results"+"/")
    shutil.copy(record.id+"_premuscle.fasta", str(usr_ip)+"_Results"+"/")
    shutil.copy(record.id+"_align.fasta", str(usr_ip)+"_Results"+"/")
    shutil.copy(record.id+"_tree.nw", str(usr_ip)+"_Results"+"/")
    shutil.copy("prosite_parsed.tsv", str(usr_ip)+"_Results"+"/")
    shutil.copy(record.id + "_domains.txt", str(usr_ip)+"_Results"+"/")
